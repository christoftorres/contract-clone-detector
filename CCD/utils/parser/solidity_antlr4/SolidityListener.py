...
class SolidityListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SolidityParser#eos.
    def enterEos(self, ctx:SolidityParser.EosContext):
        pass

    # Exit a parse tree produced by SolidityParser#eos.
    def exitEos(self, ctx:SolidityParser.EosContext):
        pass
